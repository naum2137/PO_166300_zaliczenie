...
def main():
    ...
    print(court_1)
    print("==========================")
    stadium_1 = Stadion(68, 150, "Słoneczna 10, 10-100 Olsztyn", 1999, "Słoneczny stadion", 10000, "Słoneczko")
    print(stadium_1)
    print("==========================")
    stadium_2 = Stadion(68, 150, "Słoneczna 10, 10-100 Olsztyn", 1999, "Słoneczny stadion", 10000)
    print(stadium_2)
    print("==========================")
    stadium_1.year_built = 2030
    print(stadium_1)
    print("==========================")
    Stadion.validate(stadium_1)
    print(stadium_1)
    print("==========================")
